...
AustrianGermanNormalizer AustrianGermanNormalizer::instance;

AustrianGermanNormalizer::AustrianGermanNormalizer() {
}
...
* Normalize
*/
std::string AustrianGermanNormalizer::Normalize(const std::string& text) {
